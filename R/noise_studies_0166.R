...
iteration_id <- "noise_studies_0166"
seed_num <- 577166
initial_grid_size <- 300
warp_factor <- 100 # lower = more warping
line_colour <- "#F6CE4A"
bg_colour <- "#FFECAD"

colour_vec1 <- c("#2B1B36", "#2F1E3B", "#492A44", "#63354D", "#974B5E") # 5 cols
colour_vec2 <- c("#E48056", "#E28D77", "#ECAE61", "#F6CE4A")
outline_colour <- "#F6CE4A"
...
grid <- weave_noise(
  ...
  warp_factor = warp_factor, geom_size_min = 2, geom_size_max = 4,
  subsets = 50, noise_type = "simplex")
