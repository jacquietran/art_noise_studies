...
iteration_id <- "noise_studies_0017"
seed_num <- 4878217
...
# Generate data
grid1 <- weave_noise(
  seed = seed_num, x_max = 1, y_max = 0.75, grid_length = initial_grid_size,
  warp_factor = warp_factor, geom_size_min = 0.5, geom_size_max = 3,
  noise_type = "cubic")

grid2 <- weave_noise(
  seed = seed_num, x_max = 1, y_min = 0.75, y_max = 1.5,
  grid_length = initial_grid_size, warp_factor = warp_factor,
  geom_size_min = 0.5, geom_size_max = 3, noise_type = "perlin")
