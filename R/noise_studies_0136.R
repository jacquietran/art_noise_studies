...
iteration_id <- "noise_studies_0136"
seed_num <- 789136
initial_grid_size <- 30
warp_factor <- 100 # lower = more warping
line_colour <- paletteer::paletteer_d("ochRe::olsen_seq")[3]
bg_colour <- "#E7E3DA"

colour_vec1 <- c(
  paletteer::paletteer_d("ochRe::olsen_seq")[14],
  paletteer::paletteer_d("ochRe::olsen_seq")[12],
  paletteer::paletteer_d("ochRe::olsen_seq")[11],
  paletteer::paletteer_d("ochRe::olsen_seq")[10],
  paletteer::paletteer_d("ochRe::olsen_seq")[8]) # 5 cols
colour_vec2 <- c(
  paletteer::paletteer_d("ochRe::olsen_seq")[4],
  paletteer::paletteer_d("ochRe::olsen_seq")[5],
  paletteer::paletteer_d("ochRe::olsen_seq")[6],
  paletteer::paletteer_d("ochRe::olsen_seq")[7])
outline_colour <- paletteer::paletteer_d("ochRe::olsen_seq")[3]
