...
iteration_id <- "noise_studies_0060"
seed_num <- 215760
...
colour_vec1 <- c("#131516", "#212529", "#343A40", "#495057", "#6C757D") # 5 cols
colour_vec2 <- c("#F8F9FA", "#E9ECEF", "#DEE2E6", "#CED4DA")
outline_colour <- "#ADB5BD"
...
ggplot() +
  ...
  geom_curve(
    ...
    colour = line_colour, size = 0.4, curvature = -0.3, linetype = "dotted") +
  scale_size_identity() +
