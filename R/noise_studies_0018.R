...
iteration_id <- "noise_studies_0018"
seed_num <- 4878218
...
# Generate data
grid1 <- weave_noise(
  seed = seed_num, x_max = 2, y_max = 1.8, grid_length = initial_grid_size,
  warp_factor = warp_factor, geom_size_min = 0.5, geom_size_max = 3,
  noise_type = "cubic")

grid2 <- weave_noise(
  seed = seed_num, x_max = 2, y_min = 1.4, y_max = 3,
  grid_length = initial_grid_size, warp_factor = warp_factor,
  geom_size_min = 2, geom_size_max = 5, noise_type = "perlin")
