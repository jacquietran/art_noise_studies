...
iteration_id <- "noise_studies_0019"
seed_num <- 4878219
...
# Generate data
grid1 <- weave_noise(
  seed = seed_num, x_max = 2, y_max = 1.7, grid_length = initial_grid_size,
  warp_factor = warp_factor, geom_size_min = 0.5, geom_size_max = 3,
  noise_type = "simplex")

grid2 <- weave_noise(
  seed = seed_num, x_max = 2, y_min = 1.8, y_max = 3,
  grid_length = initial_grid_size, warp_factor = warp_factor,
  geom_size_min = 0.5, geom_size_max = 3, noise_type = "simplex")
